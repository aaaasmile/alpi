...
type Viewer interface {
	...
	// supported.
	ViewMessagePart(*websrv.Context, *IMAPMessage, *message.Entity) (interface{}, error)
}
...
func viewMessagePart(ctx *websrv.Context, msg *IMAPMessage, part *message.Entity) (interface{}, error) {
